...
public class SikuliTest {
	...
	public static void main(String[] args) throws FindFailed {
		...
		Region reg = s.find("head.png").below();/*
												 * .intersection(win).highlight(
												 * debugLight);
												 */
		// Region reg =
		// win.find("head.png").below().intersection(win).highlight(debugLight);
...
/*
 * class Found implements Comparable<Found> { Match match;
 * 
 * public Found() { match = null; }
 * 
 * public Found(Match m) { match = m; }
 * 
 * public Found(Match m, Region r) { match = m; m.x += r.x; m.y += r.y; }
 * 
 * public Match getMatch() { return match; }
 * 
 * @Override public int compareTo(Found f) { Match m1 = getMatch(); Match m2 =
 * f.getMatch(); if (m1.y < m2.y) { return -1; } if (m1.y > m2.y) { return 1; }
 * return 0; } }
 */